...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataSearchExtend = __webpack_require__(30);
	var DataPaginator = __webpack_require__(31);
	var PageLoading = __webpack_require__(26);
	var DataDialog = __webpack_require__(32);
	var ContentHeader = __webpack_require__(33);
	var ModalDialog = __webpack_require__(34);
	var ConfirmDialog = __webpack_require__(35);
	var HelpTools = __webpack_require__(36);
	module.exports = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	templates['data-search'] = template({"1":function(depth0,helpers,partials,data) {
	  ...
	  return "            <ul class=\"data-tools\">\n"
	    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.searchTool : depth0),{"name":"each","hash":{},"fn":this.program(2, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
	    + "            </ul>\n";
	},"2":function(depth0,helpers,partials,data) {
	    var stack1, helper;
	  ...
	  return ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.stick : depth0),{"name":"if","hash":{},"fn":this.program(6, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "");
	},"6":function(depth0,helpers,partials,data,blockParams,depths) {
	    var stack1;
	
	  return ((stack1 = (helpers.equal || (depth0 && depth0.equal) || helpers.helperMissing).call(depth0,(depth0 != null ? depth0.columnName : depth0),"description",{"name":"equal","hash":{},"fn":this.program(7, data, 0, blockParams, depths),"inverse":this.program(9, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "");
	},"7":function(depth0,helpers,partials,data) {
	    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;
	  ...
	  return "                  <li data-paths=\""
	    ...
	    + alias3(((helper = (helper = helpers.displayName || (depth0 != null ? depth0.displayName : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"displayName","hash":{},"data":data}) : helper)))
	    + "：<span></span></p>\n                    </button>\n"
	    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.dictionaryValues : depth0),{"name":"if","hash":{},"fn":this.program(10, data, 0, blockParams, depths),"inverse":this.program(15, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
	    + "                  </li>\n";
	},"10":function(depth0,helpers,partials,data,blockParams,depths) {
	    var stack1;
	
	  return "                      <div class=\"data-search-condition data-search-checkbox\""
	    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || helpers.helperMissing).call(depth0,((stack1 = (depth0 != null ? depth0.dictionaryValues : depth0)) != null ? stack1.length : stack1),10,{"name":"compare","hash":{},"fn":this.program(11, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
	    + ">\n"
	  ...
	  return ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.searchTool : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
	    ...
	    + "              </li>\n            </ul>\n\n            <ul class=\"data-search-extend\"></ul>\n";
	},"useData":true,"useDepths":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ajax = function ajax(options) {
	  ...
	  return $.ajax(params).then(function (resp, textStatus, jqXHR) {
	    ...
	    $('#loadingPop').remove();
	    alert.create({
	      // message: resp.responseJSON.message || 'Ajax Failed!',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var create = function create(options) {
	  ...
	  // 勾选更多选项
	  $('.data-search li.data-search-more input[type=checkbox]').on('click', function () {
	    var _this = $(this);
	    var _thisName = _this.attr('name');
	    if (_this.is(':checked')) {
	      for (var i = 0; i < meta.data.length; i++) {
	        if (meta.data[i].columnName == _thisName) {
	          ...
	          WUI.DataSearchExtend.create({
	            $el: $('.data-search-extend'),
	            meta: _nowJson
	          });
	          $('.data-search-more').removeClass('active');
	
	          return true;
	        }
	      }
	    } else {
	      $('.data-search-extend').find('input[name=' + _thisName + ']').parents('li').remove();
	    }
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var create = function create(options) {
	  ...
	  $el.find('a > span').click(function () {
	    var _this = $(this).parents('li');
	    var _thisName = _this.find('input').attr('name');
	    $('.data-search-more input[name=' + _thisName + ']').prop('checked', false);
	    _this.remove();
	  });
